...
- 🧩 Strong in Next.js, React, Tailwind, Express, Firebase  
- 🤖 Interested in AI integration via Python & FastAPI  
- 📱 Exploring mobile app development with Flutter  
- 🛠️ Active contributor to college clubs and tech communities  
...
**Backend:** Express.js, FastAPI, Flask, Firebase, MongoDB  
**Mobile:** Flutter  
**Tools:** Git, GitHub, VSCode, Netlify, Vercel  
**Soft Skills:** Team Collaboration, Problem Solving, Leadership, Communication
